<?php
    ...
    $query = 'SELECT cid,title,contents.slug,metas.name,`text`,contents.created FROM contents,metas WHERE contents.type!=0 AND contents.type=metas.mid AND status=0 ORDER BY created DESC';
